...
### Conclusión PCA
Con este método no es posible reducir la dimensión de los datos por la baja correlación entre las variables, necesaria para aplicar PCA, y en consecuencia el alta varianza explicada por cada uno de los 9 componentes, lo que indica que no es factible reducir las dimensiones.
